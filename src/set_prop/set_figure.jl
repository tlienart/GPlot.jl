...
"""
function set_size!(::TBK, o, v::Tuple{<:Real, <:Real})
   w, h = v
...
"""
set_texlabels!(::TBK, o, v::Bool) = (o.texlabels = ifelse(v, v, ∅); o)
...
"""
function set_texscale!(::TGLE, o, v::String)
...
XeLaTeX or LuaLaTex.
"""
set_texpreamble!(::TBK, o, v::AbstractString) = (o.texpreamble = v; o)
...
transparent.
"""
set_transparency!(::TBK, o, v::Bool) = (o.transparency = v; o)
